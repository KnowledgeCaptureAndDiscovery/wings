...
public class ComponentResource extends WingsResource {
  ...
  public void init() {
    ...
    if (this.hasPermissions() && !this.isPage("intro")) this.cc =
      new ComponentController(config, loadExternal);
  }
  ...
  public String getComponentJSON(@QueryParam("cid") String cid) {
    if (this.cc != null) return this.cc.getComponentJSON(cid);
    return null;
  }
  ...
  public String getComponentHierarchyJSON() {
    if (this.cc != null) return cc.json.toJson(
      cc.cc.getComponentHierarchy(false).getRoot()
    );
    return null;
  }
  ...
  @Produces(MediaType.APPLICATION_JSON)
  public String getWorkflowsContainingComponent(@QueryParam("cid") String cid) {
    if (this.cc != null) return cc.json.toJson(
      this.cc.getWorkflowsContainingComponent(cid)
    );
    return null;
  }
  ...
  public Response fetchComponent(@QueryParam("cid") String cid) {
    if (this.cc != null) return this.cc.streamComponent(cid, context);
  ...
  @Path("delComponent")
  @Produces(MediaType.TEXT_PLAIN)
  public String delComponent(@FormParam("cid") String cid) {
    if (
      this.cc != null &&
      this.isOwner() &&
      !config.isSandboxed() &&
  ...
  @Path("delCategory")
  @Produces(MediaType.TEXT_PLAIN)
  public String delCategory(@FormParam("cid") String cid) {
    if (
      this.cc != null &&
      this.isOwner() &&
      !config.isSandboxed() &&
  ...
  public Response fetchComponentFile(
    ...
    if (this.cc != null) return this.cc.streamComponentFile(cid, path, context);
    return Response.status(Status.FORBIDDEN).build();
  }
