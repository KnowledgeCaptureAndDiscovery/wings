...
<html>
  <head>
    ...
    <%
      ...
      request.getAttribute("controller"); int guid = 1; String uploadApi =
      dc.config.getUserDomainUrl() + "/upload"; String thisApi =
      dc.config.getScriptPath(); String list = dc.getDomainsListJSON();
    %>
