...
public class DataCreationKB extends DataKB implements DataCreationAPI {
  ...
  public DataCreationKB(Properties props) {
    ...
    try {
      ...
      this.tmpkb.importFrom(
          this.ontologyFactory.getKB(this.dcurl, OntSpec.MICRO)
        );
    } catch (Exception e) {
      e.printStackTrace();
    }
    ...
    if (extern != null) {
      try {
        ...
        DataCreationAPI externalDC = (DataCreationAPI) classz
  ...
  public HashMap<String, ArrayList<String>> getAllDatatypeDatasets() {
    ...
    for (ArrayList<SparqlQuerySolution> row : result) {
      ...
      if (!typedata.containsKey(typeid)) typedata.put(
        typeid,
  ...
  public ArrayList<MetadataProperty> getMetadataProperties(
    ...
    ArrayList<KBObject> properties =
      this.tmpkb.getPropertiesOfClass(datatype, direct);
    ArrayList<MetadataProperty> mprops = createMetadataProperties(properties);
    this.end();
    return mprops;
  }
  ...
  public DataItem getDatatypeForData(String dataid) {
    try {
      ...
      if (cls != null) return new DataItem(cls.getID(), DataItem.DATATYPE);
      return null;
    } finally {
      this.end();
    }
  ...
  public ArrayList<DataItem> getDataForDatatype(
    ...
    try {
      ...
      if (!direct && datatype != null) {
        for (KBObject cls : this.getSubClasses(datatype)) list.addAll(
          this.getDataForDatatype(cls.getID(), direct)
        );
      }
      return list;
    } finally {
  ...
  public ArrayList<MetadataValue> getMetadataValues(
    ...
    for (String propid : propids) {
      ...
      for (KBObject val : vals) {
        if (val.isLiteral()) values.add(
          new MetadataValue(propid, val.getValue(), MetadataValue.DATATYPE)
        ); else values.add(
          new MetadataValue(propid, val.getID(), MetadataValue.OBJECT)
        );
      }
    }
    this.end();
  ...
  public MetadataProperty getMetadataProperty(String propid) {
    try {
      this.start_read();
      if (!this.kb.containsResource(propid)) return null;
  ...
  public boolean addDatatype(String dtypeid, String parentid) {
    try {
      ...
      if (this.externalCatalog != null) this.externalCatalog.addDatatype(
          dtypeid,
          parentid
        );
  ...
  public boolean removeDatatype(String dtypeid) {
    ...
    for (KBObject prop : props) {
      ...
      if (mprop.getDomains().contains(dtypeid)) {
        if (mprop.getDomains().size() > 1) this.removeMetadataPropertyDomain(
            prop.getID(),
            dtypeid
    ...
    if (this.externalCatalog != null) this.externalCatalog.removeDatatype(
        dtypeid
      );
  ...
  public boolean renameDatatype(String newtypeid, String oldtypeid) {
    ...
    if (this.externalCatalog != null) this.externalCatalog.renameDatatype(
        newtypeid,
        oldtypeid
      );
    return this.save() && this.end();
  ...
  public boolean moveDatatypeParentInLibrary(
    ...
    for (KBObject ind : this.kb.getInstancesOfClass(cls, false)) {
      for (KBObject prop : removedProps) {
        for (KBTriple triple : this.kb.genericTripleQuery(
            ind,
            prop,
            null
    ...
    if (
      this.externalCatalog != null
    ) this.externalCatalog.moveDatatypeParentInLibrary(
        dtypeid,
        fromtypeid,
        totypeid
      );
  ...
  public boolean moveDatatypeParent(
    ...
    this.start_write();
    if (!this.ontkb.setSuperClass(dtypeid, totypeid)) return false;

    if (this.externalCatalog != null) this.externalCatalog.moveDatatypeParent(
        dtypeid,
        fromtypeid,
        totypeid
      );
  ...
  public boolean moveDataParent(
    ...
    try {
      ...
      KBObject fromcls = this.kb.getConcept(fromtypeid);
      KBObject tocls = this.kb.getConcept(totypeid);
      ArrayList<KBObject> oldprops =
        this.kb.getPropertiesOfClass(fromcls, false);
      ArrayList<KBObject> newprops = this.kb.getPropertiesOfClass(tocls, false);
      ArrayList<KBObject> removedProps = new ArrayList<KBObject>();
      for (KBObject oldprop : oldprops) {
        if (!newprops.contains(oldprop)) {
      ...
      if (this.externalCatalog != null) this.externalCatalog.moveDataParent(
          dataid,
          fromtypeid,
          totypeid
        );
  ...
  public boolean addData(String dataid, String dtypeid) {
    try {
      ...
      if (this.externalCatalog != null) this.externalCatalog.addData(
          dataid,
          dtypeid
        );
      return this.save();
  ...
  public boolean renameData(String newdataid, String olddataid) {
    try {
      ...
      if (this.externalCatalog != null) this.externalCatalog.renameData(
          newdataid,
          olddataid
        );
      return this.save();
  ...
  public boolean removeData(String dataid) {
    ...
    try {
        ...
        if (f.exists()) {
          if (f.getParentFile().getAbsolutePath().equals(this.datadir)) {
            File metafile = new File(
              f.getAbsolutePath() + ExecutionFile.metaExtension
            );
      ...
      if (this.externalCatalog != null) this.externalCatalog.removeData(dataid);
      return this.save();
    } finally {
      this.end();
    }
  ...
  public boolean setDataLocation(String dataid, String locuri) {
    ...
    try {
      ...
      if (this.externalCatalog != null) this.externalCatalog.setDataLocation(
          dataid,
          locuri
        );
      return this.save();
  ...
  @Override
  public boolean setTypeAnnotations(
    String dtypeid,
    String nameFormat,
    ...
    try {
      ...
      if (this.externalCatalog != null) this.externalCatalog.setTypeAnnotations(
          dtypeid,
          nameFormat,
          sensorWorkflow
        );
  ...
  public boolean addDatatypePropertyValue(
    ...
    try {
      ...
      if (
        this.externalCatalog != null
      ) this.externalCatalog.addDatatypePropertyValue(
          dataid,
          propid,
          val,
          xsdtype
  ...
  public boolean addMetadataProperty(
    ...
    try {
      ...
      if (this.ontkb.getConcept(domain) == null) this.ontkb.createClass(domain);
  ...
  public boolean removeMetadataProperty(String propid) {
    ...
    try {
      this.start_write();
      for (String domid : prop.getDomains()) this.ontkb.removePropertyDomainDisjunctive(
          propid,
          domid
        );
  ...
  public boolean renameMetadataProperty(String oldid, String newid) {
    ...
    try {
      ...
      for (String domid : prop.getDomains()) this.ontkb.addPropertyDomainDisjunctive(
          newid,
          domid
        );
      if (
  ...
  private ArrayList<KBObject> getSubClasses(KBObject cls) {
    ...
    for (KBTriple t : this.kb.genericTripleQuery(
        null,
        this.kb.getProperty(KBUtils.RDFS + "subClassOf"),
        cls
      )) {
  ...
  private DataTree createHierarchy(String classid, boolean types_only) {
    ...
    while (!queue.isEmpty()) {
      ...
      if (item.getType() == DataItem.DATATYPE) {
        ...
        if (!types_only) {
          ArrayList<KBObject> instances =
            this.kb.getInstancesOfClass(cls, true);
  ...
  private void convertPropertyDomainsToDisjunctiveDomains() {
    ...
    for (KBObject prop : properties) {
      ...
      if (doms.size() > 1) {
        ...
        this.start_write();
        for (KBObject dom : doms) this.ontkb.removePropertyDomain(
            prop.getID(),
            dom.getID()
          );
        for (KBObject dom : doms) this.ontkb.addPropertyDomainDisjunctive(
            prop.getID(),
            dom.getID()
          );
        this.ontkb.save();
  ...
  private ArrayList<MetadataProperty> createMetadataProperties(
    ArrayList<KBObject> properties
  ) {
    ...
    for (KBObject property : properties) {
      ...
      if (!property.getNamespace().equals(this.dcdomns)) continue;
  ...
  private MetadataProperty createMetadataProperty(KBObject property) {
    ...
    int proptype = this.kb.isDatatypeProperty(property)
    ...
    ArrayList<KBObject> domains =
      this.ontkb.getPropertyDomainsDisjunctive(property);
