...
public class ExecutionFactory {
  ...
  public static PlanExecutionEngine createPlanExecutionEngine(
    String impl,
    Properties props
  ) throws Exception {
    Class<?> classz = Class.forName(impl);
    return (PlanExecutionEngine) classz
      .getDeclaredConstructor(Properties.class)
      .newInstance(props);
  }

  public static StepExecutionEngine createStepExecutionEngine(
    String impl,
    Properties props
  ) throws Exception {
    Class<?> classz = Class.forName(impl);
    return (StepExecutionEngine) classz
      .getDeclaredConstructor(Properties.class)
      .newInstance(props);
  }
}
