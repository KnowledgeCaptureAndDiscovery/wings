...
public interface LoggingKeys {
  ...
  public static String EVENT_QUERY_PROCESSCATALOG =
    "event.query.processcatalog";
  ...
  public static String EVENT_WG_GET_CANDIDATE_SEEDS =
    "event.wg.getcandidateseeds";
  ...
  public static String EVENT_PEGASUS_SITESELECTION =
    "event.pegasus.siteselection";
  public static String EVENT_PEGASUS_ADDDATASTAGING =
    "event.pegasus.adddatastaging";
  public static String EVENT_PEGASUS_ADDREGISTRATION =
    "event.pegasus.addregistration";
  ...
  public static String EVENT_PEGASUS_GENERATECLEANUP =
    "event.pegasus.generatecleanup";
  ...
  public static String EVENT_DC_CHARACTERIZE_STATUS =
    "event.dc.characterize.status";
  public static String EVENT_DC_CHARACTERIZE_STATUSES =
    "event.dc.characterize.statuses";
  ...
  public static String EVENT_DC_DISSEMINATE_DATASOURCE =
    "event.dc.disseminate.datasource";

  public static String EVENT_DC_INGEST_DATASOURCE =
    "event.dc.ingest.datasource";
  public static String EVENT_DC_GET_INGEST_STATUS =
    "event.dc.get.ingest.status";
  public static String EVENT_DC_UPDATE_INGEST_MAP =
    "event.dc.update.ingest.map";
  public static String EVENT_DC_GET_INGEST_TIME = "event.dc.get.ingest.time";

  public static String EVENT_DC_REGISTER_DATASOURCE =
    "event.dc.register.datasource";
  public static String EVENT_DC_GET_ALL_DATASOURCES =
    "event.dc.getall.datasources";
  ...
  public static String EVENT_DC_REMOVE_DATASOURCE =
    "event.dc.remove.datasource";
  public static String EVENT_DC_DATASOURCE_EXISTS =
    "event.dc.datasource.exists";
  ...
  public static String EVENT_DC_AUGMENT_DATASOURCE =
    "event.dc.augment.datasource";
  public static String EVENT_DC_GET_AUGMENTED_TYPES =
    "event.dc.get.augmented.types";

  public static String EVENT_DC_SATURATE_DATASOURCE =
    "event.dc.saturate.datasource";
  public static String EVENT_DC_GET_SATURATED_TYPES =
    "event.dc.get.saturated.types";

  public static String EVENT_DC_GET_DATASOURCE_LOCATIONS =
    "event.dc.get.datasourcelocations";
  public static String EVENT_DC_ADD_DATASOURCE_LOCATION =
    "event.dc.add.datasourcelocation";
  public static String EVENT_DC_REMOVE_DATASOURCE_LOCATION =
    "event.dc.remove.datasourcelocation";
  ...
  public static String PERFMETRIC_MEMORY_UTILIZATION =
    "perfmetric.memory.utilization";
  public static String PERFMETRIC_NETWORK_BANDWIDTH =
    "perfmetric.network.bandwidth";
