...
public interface LoggingKeys {
	...
	public static String EVENT_DC_GET_UNCHARACTERIZED_DATASOURCES = "event.dc.getuncharacterized.datasources";
	...
	public static String EVENT_DC_GET_DATASOURCE_UUID_FOR_DESCRIPTION = "event.dc.get.datasource.uuid.for.description";
	public static String EVENT_DC_GET_DATASOURCE_DESCRIPTION_FOR_UUID = "event.dc.get.datasource.description.for.uuid";
	public static String EVENT_DC_SET_DATASOURCE_DESCRIPTION_FOR_UUID = "event.dc.set.datasource.description.for.uuid";
