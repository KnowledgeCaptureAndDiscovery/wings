...
public class WmServicesServlet extends CXFNonSpringJaxrsServlet {
  ...
  private static final Logger LOGGER = Logger.getLogger(
    WmServicesServlet.class.getName()
  );
  ...
  public void init(ServletConfig configuration) throws ServletException {
    ...
    try {
      ...
      if (urlParameter != null) {
        ...
        LOGGER.log(
          ...
          " (\"" +
          PARAM_NAME_URL +
          "\") for the workflow manager's URL."
        );
      ...
      LOGGER.log(
        Level.SEVERE,
        "Encountered a malformed URL for the workflow manager.",
        e
      );
    ...
    if (pkgRepoDirPath != null) {
      File workflowDir = new File(
        PathUtils.replaceEnvVariables(pkgRepoDirPath)
      );
